...
- Content-funding MVP is complete: contracts, SDK, platform API service, content attester infrastructure (three deployable noninflammatory attester variants), and UI integrations (Channel Page, Pubstarter Project Detail, ContentFundingProjectSection). Content attestation badges now surface on Channel Page and Pubstarter Project Detail for attested content items.
