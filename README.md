...
- Indexer redesign Phase 4 **in progress**: Fixed foldAlignmentAttestations bug (topicStatementId field missing from ABI/decoder). 239 SDK tests passing. Still need to migrate pubstarter, delegation, and mutable-refs queries to event cache + folds.
