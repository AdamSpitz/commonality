...
- Content-funding smart contracts reviewed and fixed: access control (Ownable), escrow routing for unclaimed channels, dead code removal, consistent duplicate-content error handling for creator-created contracts, and creator-controlled channel coverage in the Hardhat tests. Still needs indexer + UI integration.
