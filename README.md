...
- Content-funding smart contracts reviewed and fixed: access control (Ownable), escrow routing for unclaimed channels, dead code removal, and creator-controlled channel coverage in the Hardhat tests. Still needs indexer + UI integration.
