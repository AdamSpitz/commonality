...
**Branch structure:** See [workflow/branching.md](workflow/branching.md). Briefly: work in `dev`, promote to `master` via merge. Commits to dev are gated by a quicker test suite; pushes to master are gated by the full test suite.
