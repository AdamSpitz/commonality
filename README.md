...
- All tests passing: 1252 total (243 SDK + 324 Hardhat + 107 integration + 616 UI). E2e tests exist for all major subsystems (pubstarter, fundingportals, mutablerefs, marketplace).
