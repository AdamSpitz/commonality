...
- Content-funding MVP complete: contracts, SDK, deployment, fake-data, platform API service, and UI all implemented. Real `ChannelVerifier` contract deployed (replaces mock). Remaining: Claim Flow UI, 5 minor UI/SDK bugs (see TODO.md).
