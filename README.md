...
- Content-funding MVP complete: contracts, SDK, deployment, fake-data, platform API service, and UI all implemented. Real `ChannelVerifier` contract deployed (replaces mock). Remaining: Claim Flow UI, wiring Create Contract page to Platform API Service (see TODO.md).
