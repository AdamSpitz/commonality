...
- Content-funding MVP complete: contracts, SDK, deployment, fake-data, and UI all implemented and bug-fixed (ContractVetoed event and CreatorContractCreated.creator field corrections applied).
