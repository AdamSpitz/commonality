...
- **[LazyGiving](tech/subsystems/lazyGiving/README.md)** — Individual crowdfunding projects with Kickstarter-style assurance contracts, non-transferable recognition receipts, and at-cost reimbursement of early contributors after successful work.
...
- **[Aligning](tech/subsystems/aligning/README.md)** — Per-statement portals showing projects aligned with a cause (directly or via the implication graph), with contributor leaderboards and full delegation-chain transparency.
