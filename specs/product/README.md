...
- **[marketing/](marketing/README.md)** — Research, positioning, and cause-flavored share tooling (not umbrella ads). Plan: [marketing/PLAN.md](marketing/PLAN.md).
...
- **[fund-now-claim-later.md](fund-now-claim-later.md)** — Generalize unclaimed-channel escrow: third parties pool money for a public identity (MVP: a website) before the beneficiary is on the system; they cannot take it; we are not the intermediary. Tech: [claimable-beneficiaries.md](/specs/tech/subsystems/claimable-beneficiaries.md). Current [focus](/focus.md).
- **[ux.md](./ux.md)**
