...
- **[causes-as-publications.md](causes-as-publications.md)** — Proposed target model for AI-assisted cause creation: causes are mutable, shareable publications over immutable statements; organizers and vertical operators are distinct roles; anchors remain optional semantic statements rather than page identities.
