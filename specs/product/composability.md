...
ERC-1155 contribution receipts record recognition separately from an early contributor's reimbursement accounting. Once trusted success attestations indicate that a project delivered real impact, later donations can enter its capped reimbursement waterfall. The pool makes funds available to early contributors pro rata, never beyond what each person contributed; receipts remain non-transferable. [Retroactive funding](/docs/end-user/lazyGiving/retroactive-funding.md) is therefore a composition of success attestations, reimbursement accounting, and donation routing—not a market or an opportunity for profit.
