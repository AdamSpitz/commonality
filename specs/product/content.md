...
The AI assistant's system prompt (written up as an [AI skill](ai-assistance.md)) should include the key points from [ease-of-adoption/](/docs/end-user/commonality/vision-and-strategy/ease-of-adoption/) so it can make them naturally in conversation when relevant. The main points the AI needs to internalize:
