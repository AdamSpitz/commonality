# Marketing posture: who, and who not

*Hub: [README.md](./README.md). Plan: [PLAN.md](./PLAN.md).*
...
But I'm not particularly interested in doing marketing to try to get end-users to use the core infrastructure. It's something they *could* do (the verticals like Civility put a nice cause-specific facade on top of it, the Commonality surface is the founder front door), but honestly I suspect most early adoption will come in a more structured way from other verticals: some "founder" type starts a vertical for a cause he cares about, and then marketing it is his problem, not mine. (In fact, I expect that I'll disapprove of many of the uses that people will put this infrastructure to; that's the downside of building neutral tools.)
...
Anyway, the point is that there's two kinds of marketing here:
  ...
  - And NOT any aimed at end-users of the infrastructure in general or end-users of other verticals that I'm not personally running.

**A third kind that is *not* marketing:** friend walkthroughs and other qualitative research. That is how we find out whether the first two kinds could ever work. Do it on testnet, with a script, without asking anyone to "sign up for Commonality." See [friend-walkthroughs.md](./friend-walkthroughs.md).
...
These stay on the [founder-first backlog](../founder-first.md). They are the wrong altitude until friend walkthroughs show the idea survives a non-author.
...
- Keep working on [memes](./memes.md).
...
First vertical *content* (one 90s clip, a handful of memes) is phase 4 of [PLAN.md](./PLAN.md), after walkthroughs.
