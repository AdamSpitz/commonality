...
## The coordination taxes
  ...
  - **Irreversible commitments:** Voting for a candidate is a four-year commitment. Donating to a charity means your money is gone even if the charity starts doing things you don't like. In Commonality, pledges refund if the threshold isn't met, delegation is revocable, signing a statement is free. See [costless-to-try](./costless-to-try.md).
...
Commonality propagates individuality much further down the pipeline. The result: collective-scale outcomes without the [lossy](../why-its-better/individualization.md) and [frustrating](../ease-of-adoption/no-need-to-compromise.md) early-aggregation step.
