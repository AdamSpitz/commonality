...
- **`personal-funding-board`**: The wallet user's public CauseStarter dashboard definition: included statement CIDs, geographic scope, and an optional preferred money source. Cached locally and explicitly synchronized; conflicting device and wallet copies require a user choice rather than silently overwriting either one.
