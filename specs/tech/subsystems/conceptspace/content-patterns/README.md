...
See [hidden majority](./hidden-majority.md).

## Noninflammatory social-media content

See [noninflammatory content](./noninflammatory-content.md).

## Early use cases for Commonality

Based on domain analysis (i.e. I thought for a while and then guessed), these areas are likely good early candidates:
