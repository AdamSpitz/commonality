...
Some points about this:
  ...
  -   **Retroactive Funding:** NFTs can be resold on the secondary market, creating a distinction between "investors" (holding tokens, may sell later) and "donors" (tokens burned). See [docs/end-user/shared/key-ideas/retroactive-funding.md](/docs/end-user/shared/key-ideas/retroactive-funding.md) for the full explanation. The mechanism: early backers can exit by selling to altruistic donors later — nano-VCs for public goods.
