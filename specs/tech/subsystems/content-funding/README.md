...
For the user-facing explanation of what content funding is and why it exists, see [docs/end-user/content-funding/content-funding.md](/docs/end-user/content-funding/content-funding.md).
...
- **[Materialization](materialization.md)** — ⚠️ *Design note, unresolved.* How a funded future-content round turns into concrete content items. The redemption half of future-content rounds **cannot currently execute**; read this before touching `MaterializedContentTokens`.
...
- **[UI](ui.md)** — Pages and components: browse creators, channel page, create contract, creator dashboard, and integration with LazyGiving and Aligning.
