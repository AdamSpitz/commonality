...
- **How long is a beat agent's context window, and how does it decay?** A week of ingestion? A month? Continuous summary with periodic compaction? This is partly an LLM-cost question and partly a "how stale can ambient context get before it's misleading" question.
  - USER: I'm tempted to say that the answer (which I think is roughly what I'm doing inside my own head when I follow social media) is something like exponential backoff with summarization. Not in any formal sense, but as info gets older it should be made lower-resolution. i.e. If I'm following someone who's actively posting, I remember a decent amount about what kinds of things he's saying, e.g. "conservative with some libertarian leanings, and he's been talking a lot about crime statistics and NIMBYism and immigration, it's fun to read him but I often have quibbles with what he says"; after a month goes by I remember just the highlights, e.g. "conservative with some libertarian leanings, funny"; after a year goes by I kinda just have a bit or two of info, e.g. "right wing". So maybe keep timestamps next to observations and replace them with lower-resolution summaries as time goes on and we want to conserve space? (Not disk space, but context-window space.)
