...
Previously, the five logical subsystems (Concept Space, LazyGiving, Marketplace, Delegation, Aligning) were described as separate indexers with federation via GraphQL. **This is no longer the case.**
