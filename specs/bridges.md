...
See [motivation/ease-of-adoption/bridges.md](motivation/ease-of-adoption/bridges.md) for the architectural spec. This document focuses on the practical question: what does a normal person actually experience when contributing via credit card?
