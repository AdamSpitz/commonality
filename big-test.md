...
- Changed LazyGiving fake-data project creation to upload actual project metadata to IPFS with human-readable seed names/descriptions instead of fake CIDs that force the UI to fall back to `Project 0x...`.
