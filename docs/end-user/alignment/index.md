...
- **[Statements and the implication graph](../shared/key-ideas/statements-and-implication-graph.md)** — Causes are statements. Statements that mean similar things get connected automatically, so portals span natural coalitions even when nobody coordinated wording.
...
- **[Funding portals](../shared/key-ideas/assurance-contracts.md)** — The crowdfunding mechanism the projects themselves use.
