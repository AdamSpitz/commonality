...
Aligning gives you both at once: **pledge to a cause and let someone you actually know and trust direct the funds.** You get the fire-and-forget ease of the charity *and* the confidence that your money's in good hands — not a compromise between them.
...
Projects themselves are created and funded on [LazyGiving](../lazyGiving/index.md). Aligning is the discovery and delegation layer on top: it groups projects by cause, filters them through people whose judgment you trust, and lets you hand the funding decisions to a delegate.

## How a portal gets populated

1. Someone posts a project on LazyGiving.
2. Someone — anyone — *vouches* that the project is aligned with a particular cause.
3. If that voucher is in your trust network, the project shows up in your portal for that cause.

There's no committee deciding what counts. The portal you see is a function of who you trust.

[Read the longer walkthrough →](how-alignment-works.md)
...
- **[Assurance contracts](../lazyGiving/assurance-contracts.md)** — The crowdfunding mechanism the projects themselves use.
