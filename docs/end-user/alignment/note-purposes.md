...
Aligning adds one thing on top: when you create a note, you can **mark it as explicitly meant for a particular purpose**.
...
This matters most on Aligning, because Aligning is where money is routed by *cause* rather than by individual project. A delegate (or a cause pool) holding purpose-marked notes knows not just that they've been trusted with funds, but what those funds were meant to advance. The earmark:
