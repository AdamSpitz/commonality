...
### It works for existing orgs
  ...
  - **[Claiming an org](./claiming-an-org.md):** Third parties can pool money for a named org *before* the org has heard of us, keyed to the org's website ([fund-now-claim-later](/specs/product/fund-now-claim-later.md)). The third party cannot take the funds.
