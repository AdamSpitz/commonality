...
## Success evaluators (people who recognize results)

"Don't want to predict winners? Follow completed work instead. When something
demonstrably delivered, vouch for its success so people whose trust networks reach you
can find it. Later donors can reimburse its early contributors at cost. Careful
retrospective judgment is useful even if you never select a proposal or write a large
check."
...
This applies to unusually large contributors too. A person with exceptional capital,
judgment, execution ability, trust, or distribution can contribute that one thing
