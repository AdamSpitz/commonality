...
The everyday catalog of those jobs is **[Do the part you’d do anyway](./the-jobs.md)**. The spoken pitch is back on **[CauseStarter](./index.md)**. The longer case (why this beats government and charity, why switching is easy, why it is hard to shut down) lives in the [vision and strategy](../commonality/vision-and-strategy/README.md) notes. You do not need those to use a cause board.
