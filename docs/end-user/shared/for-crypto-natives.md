...
- **Commonality job map for agents** ([commonality/for-llms.md](../commonality/for-llms.md)) — which SDK subpath or HTTP service (attesters, cause-assist, nudgers) to use; not a second TypeDoc.
