...
Solution: We use Commonality's [assurance contracts](/docs/end-user/lazyGiving/assurance-contracts.md) (which solve the free-rider problem) and [delegation](/docs/end-user/shared/key-ideas/delegation.md) (which solves the laziness problem) to crowdfund noninflammatory content and aligned projects. Retroactive funding also lets people see already-existing noninflammatory content before donating; their donations reimburse its early contributors at cost so those scouts can fund the next attempt.
