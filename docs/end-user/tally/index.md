...
- **No follow-through.** Signing a petition is the end of the interaction. Tally is designed so a signature can become a signal that other tools — fundable-projects boards, organizing sites, content-funding contracts — can act on. Your signature on a statement about clean water can route real money toward projects that serve it.
