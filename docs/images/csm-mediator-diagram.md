...
`csm-mediator-diagram.svg` — a diagram of the core Common Sense Majority idea: how the mediator reveals hidden common ground. See the canonical [hidden-majority patterns](/docs/end-user/common-sense-majority/hidden-majority-patterns.md) explanation and [the mediator vision doc](/docs/end-user/common-sense-majority/mediator.md).
...
The [hidden-majority sub-patterns](/docs/end-user/common-sense-majority/hidden-majority-patterns.md#the-sub-patterns) imply different geometries, e.g.:
