...
const DelegatableNotesAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "enum DelegatableNotes.TokenType", name: "tokenType", type: "uint8" },
      { indexed: false, internalType: "uint256", name: "tokenId", type: "uint256" },
      { indexed: false, internalType: "bytes32", name: "intendedStatementId", type: "bytes32" },
    ],
    name: "NoteCreated",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "uint256", name: "parentNoteId", type: "uint256" },
      { indexed: true, internalType: "uint256", name: "childNoteId", type: "uint256" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "uint256", name: "originalLeafId", type: "uint256" },
      { indexed: true, internalType: "uint256", name: "splitLeafId", type: "uint256" },
      { indexed: true, internalType: "uint256", name: "remainderLeafId", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "splitAmount", type: "uint256" },
    ],
    name: "ChainSplit",
    type: "event",
  },
