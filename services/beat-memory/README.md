...
See `services/beat-memory/config/us-political-csm.example.json` for a small local rehearsal beat definition.
...
BEAT_MEMORY_MEMORY_FILE=services/beat-memory/data/us-political-csm.memory.json \
