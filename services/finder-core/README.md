...
Finder-specific services such as `services/implication-finder/`, `services/content-finder/`, and beat-agent finder mode keep their source adapters, service wiring, and domain-specific request/response shapes local, and import the shared pieces from this package.
