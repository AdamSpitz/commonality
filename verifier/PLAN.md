...
No open items. The backlog is clear; new items come from `meta.llm-to-automated-candidates` advisory findings or triage of `meta.verifier-health` non-green states.
