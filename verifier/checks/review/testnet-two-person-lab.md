...
1. Open `https://testnet.commonality.works` over HTTPS. The shell loads. `config.json` points at deployed indexer / contracts / cause-assist / implication attester — not localhost.
