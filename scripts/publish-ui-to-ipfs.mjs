...
const UI_ENV_ADDRESS_MAPPINGS = {
  ...
  BENEFICIARY_IDENTITY_ADDRESS: 'VITE_BENEFICIARY_IDENTITY_ADDRESS',
  BENEFICIARY_REGISTRY_ADDRESS: 'VITE_BENEFICIARY_REGISTRY_ADDRESS',
  BENEFICIARY_VERIFIER_ADDRESS: 'VITE_BENEFICIARY_VERIFIER_ADDRESS',
  BENEFICIARY_ESCROW_ADDRESS: 'VITE_BENEFICIARY_ESCROW_ADDRESS',
