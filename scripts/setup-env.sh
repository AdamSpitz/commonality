...
ROOT_VARS=(
  ...
  IMPLICATION_ATTESTER_PRIVATE_KEY CONTENT_ATTESTER_PRIVATE_KEY VERIFIER_PRIVATE_KEY
  ...
  DEPLOYER_ADDRESS ENS_OWNER_ADDRESS IMPLICATION_ATTESTER_ADDRESS CONTENT_ATTESTER_ADDRESS
  ...
  IMPLICATION_ATTESTER_PAYMENT_ADDRESS CONTENT_ATTESTER_PAYMENT_ADDRESS
  ...
  EVENT_CACHE_URL
  VITE_COMMONALITY_URL VITE_PUBSTARTER_URL VITE_ALIGNMENT_URL VITE_TALLY_URL
...
# ============================================================
{
  ...
  echo "VITE_PUBSTARTER_URL=${VARS[VITE_PUBSTARTER_URL]:-}"
