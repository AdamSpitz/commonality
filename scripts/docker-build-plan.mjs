...
const buildConfigs = {
  ...
  'attester-host': {
    buildKey: 'attester-host',
    image: 'commonality-attester-host:dev',
    hashEntries: [
      '.dockerignore',
      '.npmrc',
      'package.json',
      ...
      { path: 'attester-host', ignore: ['dist'] },
    ],
  },
  'worker-host': {
    buildKey: 'worker-host',
    image: 'commonality-worker-host:dev',
    hashEntries: [
      '.dockerignore',
      '.npmrc',
      'package.json',
