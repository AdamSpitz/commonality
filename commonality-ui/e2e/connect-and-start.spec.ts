...
/**
 * Smoke: open Commonality → connect Hardhat #0 → start a cause → write and
...
function appPath(path: string): string {
  ...
  const hashMode = process.env.COMMONALITY_UI_HASH_ROUTING !== '0'
...
test.describe('Commonality agent smoke', () => {
