...
**Generation process for later clusters (and LLM bulk seed):** [statement-generation.md](./statement-generation.md). Exercise 1 (simple causes, no triples) is in [statement-generation-exercises/](./statement-generation-exercises/) — statements accepted as useful, not copied into `seed-content` yet. Not this pairing.
