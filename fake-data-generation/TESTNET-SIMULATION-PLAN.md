...
7. **[ ] Run and inspect the full 100-user campaign locally.** Local execute mined all 1932 actions in ~196s (concurrency 4); after harness fixes, reconciliation is 1932/1932 with lag 0. See [`campaigns/medium-realistic-v1-local-run.md`](./campaigns/medium-realistic-v1-local-run.md). Remaining: inspect representative CauseStarter pages against a UI pointed at local chain 31337 (current Vite/IPFS bundles were on Base Sepolia).
