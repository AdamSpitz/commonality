# Statement-generation exercises

Draft corpora for the loop in [`../statement-generation.md`](../statement-generation.md).

**Do not** put files here into `seed-content/` until a human accepts them. `loadSeedCollections` only reads `seed-content/*.json`.
