  ...
  return (
    <Box>
      ...
      <Typography variant="body1" color="text.secondary" sx={{ mb: 3, maxWidth: 760 }}>
        LazyGiving, Aligning, and Content Funding can all route donations through delegates. On each supporting site, donations show up as “Alice Donor (delegated via Bob Delegate)”.
      </Typography>
      <Stack spacing={2}>
        {['LazyGiving', 'Aligning', 'Content Funding'].map((site) => (
