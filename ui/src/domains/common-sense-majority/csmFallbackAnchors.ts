import type { BridgeAnchorRecord } from './csmBridges'

/** Bundled CSM reference fallback used when no mediator service is deployed. */
export const csmFallbackAnchors: BridgeAnchorRecord[] = [
  {
