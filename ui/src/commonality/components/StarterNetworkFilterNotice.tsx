...
/** True when Commonality is filtering vouches through the starter network. */
 ...
 * trust set and Commonality is filtering vouches through the starter network.
 */
export function StarterNetworkFilterCopy() {
  ...
  return (
    <Typography variant="body2" data-testid="starter-network-filter-notice">
      Projects are filtered using Commonality's starter network. You can replace it with
      your own choices in{' '}
