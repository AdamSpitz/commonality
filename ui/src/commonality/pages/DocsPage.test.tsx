...
describe('DocsPage', () => {
  it('renders the Commonality home guide', () => {
    renderDocs('/docs')
    ...
    expect(screen.getByRole('link', { name: /Commonality API map \(for LLMs\)/i })).toHaveAttribute(
      'href',
      '/docs/for-llms',
    )
  ...
  it('renders the LLM API map', () => {
    ...
    expect(screen.getByRole('heading', { name: /Commonality API map/i })).toBeInTheDocument()
