...
import { formatCurrencyAmountWithLocalEstimate, formatCurrencyProgress } from '../../shared/funding'
  ...
  return (
    <Box>
      ...
      <Typography variant="body1" color="text.secondary" sx={{ mb: 3, maxWidth: 680 }}>
        Projects are crowdfunding efforts backed by assurance contracts: your contribution is fully refundable if the funding goal isn't met. If the project succeeds, your onchain receipt remains non-transferable; later donors can close the loop by donating into the reimbursement flow.
      </Typography>
