...
export type RuntimeConfigKey =
  ...
  | 'VITE_LOCAL_FIAT_CURRENCY'
  | 'VITE_LOCAL_FIAT_SYMBOL'
  | 'VITE_LOCAL_FIAT_USD_RATE'
  | 'VITE_LOCAL_FIAT_RATE_TIMESTAMP'
...
const buildTimeConfig: UiRuntimeConfig = {
  ...
  VITE_LOCAL_FIAT_CURRENCY: import.meta.env.VITE_LOCAL_FIAT_CURRENCY,
  VITE_LOCAL_FIAT_SYMBOL: import.meta.env.VITE_LOCAL_FIAT_SYMBOL,
  VITE_LOCAL_FIAT_USD_RATE: import.meta.env.VITE_LOCAL_FIAT_USD_RATE,
  VITE_LOCAL_FIAT_RATE_TIMESTAMP: import.meta.env.VITE_LOCAL_FIAT_RATE_TIMESTAMP,
