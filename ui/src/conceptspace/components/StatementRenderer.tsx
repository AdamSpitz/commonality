...
export function StatementRenderer({
  ...
  if (isDisplayableDocument(content)) {
    return <DisplayableDocumentRenderer statementId={statementId} doc={content} />
  }

  return <LegacyStatementRenderer statementId={statementId} content={content} />
}
...
// ============================================================================
// Legacy StatementContent renderer (backward compatibility)
// ============================================================================

function LegacyStatementRenderer({
  statementId,
  content,
}: {
  statementId: string
