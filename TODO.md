...
- See [LLMployees.md](./LLMployees.md).
  - Incorporate the Grok suggestions that Sam added.
  - Put together a quite-detailed test plan. *Then* go through that plan and figure out which can be automated and which need to be done by an intelligent LLM.
