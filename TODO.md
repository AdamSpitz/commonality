...
- CSM landing page rework. The hero copy and spotlights are in decent shape, but the heroActions and sections are wrong: they point at thin placeholder pages instead of the real actions a new user should take. The landing page should explain the point + offer concrete actions, mirroring the "Basic things you can do" list in [docs/end-user/csm/index.md](docs/end-user/csm/index.md). Remaining work:
