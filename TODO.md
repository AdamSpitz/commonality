...
- [ ] **(Tell)** Finish/polish "successful projects" on cause boards (see [specs/product/successful-projects.md](specs/product/successful-projects.md)): consider replacing the first-pass direct-vs-indirect success confidence score with richer trust-graph weighting/discovery-slider behavior. Policy questions on open posting, reputation/decay, and domain-scoped success trust are decided in the spec.
