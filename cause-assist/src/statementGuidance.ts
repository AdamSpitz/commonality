...
- If the claim is about a particular place (city, county, park, building, watershed, school, etc.), name it so a stranger can tell which one. "I want more public parks in Springfield" is not determinate: there are many Springfields. Prefer "Springfield, Illinois" / "Grey County, Ontario" / "High Park in Toronto" over a bare toponym. Worldwide or genuinely unscoped wants stay unscoped; do not invent a place to look specific.
