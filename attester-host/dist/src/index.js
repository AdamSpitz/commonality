...
export function createAttesterHostApp(config, factories = {}) {
    ...
    app.use(config.implicationAttester.routePrefix, createImplicationApp(config.implicationAttester.config));
    app.use(config.contentAttester.routePrefix, createContentApp(config.contentAttester.config));
