...
The last closed item was [conceptspace repo-split analysis](./specs/tech/conceptspace-repo-split-analysis.md) (in-repo dependency direction; a second repository stays a later decision).
